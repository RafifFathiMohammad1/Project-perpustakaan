...
if (isset ($_GET['ID'])){
    ...
    if (isset($_POST['ubah'])){
        if(ubah_user_Admin($_POST) > 0){
            echo "<script>alert('Data Berhasil di ubah'); document.location.href='DSis.php';</script>";
        }else{
            echo "<script>alert('Data gagal di ubah'); document.location.href='DSis.php';</script>";
        }
    }
...
<h1 class="text-center" style="color: #f15748 ;">Ubah User</h1>
    ...
    <div class="container d-flex justify-content-center align-items-center min-vh-80">
    <button type="button" class="btn btn-danger"><a href="DSis.php" style="text-decoration: none; color: white;">Kembali</a></button> 
    </div>
</body>
</html>