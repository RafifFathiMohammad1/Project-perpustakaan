...
if (isset($_POST['tambah'])){
    ...
    echo"<script>alert('Data Berhasil di Tambahkan'); document.location.href='login.php';</script>";
    } else{
    echo"<script>alert('Data Gagal di Tambahkan'); document.location.href='login.php';</script>";
    }
}
?>
...
<body style="background-color:black;">
    ...
    <div class="container d-flex justify-content-center align-items-center min-vh-80">
    <button type="button" class="btn btn-danger"><a href="login.php" style="text-decoration: none; color: white;">Kembali</a></button>
    </div>
