<?php
    ...
    //sql menampilkan
    $data_masuk = select("SELECT * FROM masuk WHERE Level= 2");
?>
  ...
  <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarToggleExternalContent" aria-controls="navbarToggleExternalContent" aria-expanded="false" aria-label="Toggle navigation">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="nav nav-tabs">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="DPet.php">Petugas</a>
        </li>
        <li class="nav-item">
            ...
            <tbody>
                ...
                <?php foreach ($data_masuk as $masuk) :?>
                    <tr>
                        ...
                        <td><?= $masuk['Status'];?></td>
                        <td>
                        <button type="button" class="btn btn-danger"><a href="hapususerP.php?id=<?=$masuk['ID']; ?>" onclick="return confirm('Yakin ingin menghapus produk ini?')" style="text-decoration: none; color: white;">Hapus</a></button>
                        <button type="button" class="btn btn-warning"><a href="ubahuserP.php?ID=<?=$masuk['ID']; ?>" style="text-decoration: none; color: white;">Ubah</a></button>
                        </td>
                    </tr>
                <?php endforeach;?>
            </tbody>
